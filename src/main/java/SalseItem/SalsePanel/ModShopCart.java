...
import SalseItem.ModTool.ModTool;
import SalseItem.PayJDialog.MyPay;
    ...
    private void initComponents() throws SQLException {
        ...
        button4.addActionListener(a->{
            ...
            try {
                ...
                Container container = this.getContentPane(); //将窗体转换为容器
                //user_car car = new user_car(colnum,id,title,price,num,user_id,name);
                String sql = "select u.user_name,sum(price*num) from currentuser c,user_car u where c.user_name = u.user_name  group by(user_name)";
